#include "megalayprocessor.h"	// for AGain
#include "megalaycontroller.h"  // for AGainController
...
BEGIN_FACTORY_DEF ("BassBuster", "http://www.bassbuster.ru", "mailto:bassbuster@mail.ru", 2)

//---First Plug-in included in this factory-------
DEF_CLASS (Steinberg::Vst::AMegalayProcessorUID,
           ...
           Steinberg::Vst::AMegalay::createInstance,// function pointer called when this component should be instanciated
           nullptr)

// its kVstComponentControllerClass component
DEF_CLASS (Steinberg::Vst::AMegalayControllerUID,
           Steinberg::PClassInfo::kManyInstances,    // cardinality
           ...
           FULL_VERSION_STR,                   // plug-in version (to be changed)
           kVstVersionString,                  // the VST 3 SDK version (dont changed this, use always this define)
           Steinberg::Vst::AMegalayController::createInstance, // function pointer called when this component should be instanciated
           nullptr)
